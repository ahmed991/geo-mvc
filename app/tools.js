...
export function createMap(divId) {
  ...
  brtResolutions = [3440.64, 1720.32, 860.16, 430.08, 215.04, 107.52, 53.76, 26.88, 13.44, 6.72,
    3.36, 1.68, 0.84, 0.42, 0.21];
  var map = new Map({
    target: divId + "_div",
    view: new View({
      projection: nlProjection, //CULPRIT
    ...
    layers: [
      new TileLayer({
        ...
        source: new WMTS({
            ...
            style: 'default',
            wrapX: false,
            attributions: 'Base Map: &copy; <a href="https://www.kadaster.nl">Kadaster</a>'
        })
      })
    ]
  });
